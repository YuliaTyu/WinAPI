...
{
	//1 hInstance экземпляр запущенного .exe файла нашей прогораммы 
	//2 hPrevInst предыдущий запущенный экземпляр нашей программы
	//3 lpCmdLine командная строка с которой была запущена программа
	//4 nCmdShow  режим отображения окна - развернута на весь экран, свернута в окно или на панель задач
